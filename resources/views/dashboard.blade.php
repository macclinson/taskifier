            ...
            @foreach($tasks as $task)
              ...
              <div class="task-wrapper pending-task">
                ...
                <div class="action-btns">
                  <a href="/tasks/{{$task->id}}/edit" class="edit-task" @click="pageLoader()" data-toggle="tooltip" data-placement="bottom" title="Edit Task">
                  ...
                  <form class="complete-task" method="POST" action="/complete/{{$task->id}}">
                    ...
                    <button type="submit" @click="pageLoader()" data-toggle="tooltip" data-placement="bottom" title="Done">
                      <i class="material-icons">done</i>
                    </button>
                  </form>
                  <span class="delete-task" data-toggle="tooltip" data-placement="bottom" title="Delete">
              ...
              <div class="task-wrapper completed-task">
                ...
                <div class="action-btns">
                  <form class="incomplete-task" method="POST" action="/incomplete/{{$task->id}}">
                    ...
                    <button type="submit" @click="pageLoader()" data-toggle="tooltip" data-placement="bottom" title="Undo">
                      <i class="material-icons">undo</i>
                    </button>
                  </form>
                  <a href="/delete/{{$task->id}}" @click="pageLoader()" class="delete-task" data-toggle="tooltip" data-placement="bottom" title="Delete">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-body text-center">
                      ...
                      <a href="/delete/{{$task->id}}" class="btn btn-danger" @click="pageLoader()">Yes, delete</a>
                    </div>
                  </div>
                </div>
              </div>
